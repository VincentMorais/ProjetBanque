    ...
    class ClientDao 
    {
        ...
        public  Client getClient(int unNumero)
        {
            ...
            try
            {
               ...
               maConnexionSql = ConnexionSql.getInstance(Fabrique.ProviderMysql, Fabrique.DataBaseMysql, Fabrique.UidMysql, Fabrique.MdpMysql);
                ...
                Ocom = maConnexionSql.reqExec("Select * from clients where numero = " + unNumero);
        ...
        public void updateClient(Client c)
        {
            ...
            try
            {
                ...
                Ocom = maConnexionSql.reqExec("UPDATE clients SET adresse = '" + c.Adresse + "'WHERE numero ='" + c.Num + "'");
        ...
        public List<Client> getClients()
        {
            ...
            try
            {
                ...
                Ocom = maConnexionSql.reqExec("Select * from clients");
